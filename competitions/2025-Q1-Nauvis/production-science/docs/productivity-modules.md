<h1>Q1 Production Science Competition: Prod Modules</h1>
...
* all design blueprints are [here](../benchmarks/prod-modules/blueprints.txt)
* all designs are throttled to 160/s with circuit controlled inserters

## Results
![alt text](../benchmarks/prod-modules/charts/summary_run_distribution_all_2_sigma.png)

![alt text](../benchmarks/prod-modules/charts/summary_verbose_metrics_average_all_designs.png)
...
The top two designs are all fully DI.
...
![alt text](../benchmarks/prod-modules/thaeln_cars_comparison/charts/metrics.png)
