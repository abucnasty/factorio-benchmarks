...
belt-charts boxplot "results/bm_*160_belted_abuc_3_furnace*.csv" \
    -w 1200 \
    -h 800 \
...
belt-charts summary "results/bm_*160_belted_abuc_3_furnace*.csv" \
    -w 1500 \
    -h 800 \
    --remove-first-ticks 7200 \
...
belt-charts boxplot "results/bm_*40_belted_abuc*.csv" \
    -w 1200 \
    -h 800 \
    --remove-first-ticks 7200 \
...
belt-charts summary "results/bm_*40_belted_abuc*.csv" \
    -w 1500 \
    -h 800 \
    --remove-first-ticks 7200 \
...
belt-charts boxplot "results/bm_*belted*.csv" \
    -w 1200 \
    -h 800 \
    --remove-first-ticks 7200 \
...
belt-charts summary "results/bm_*belted*.csv" \
    -w 1500 \
    -h 800 \
    --remove-first-ticks 7200 \
...
belt-charts boxplot "results/bm_*on_patch*.csv" \
    -w 1200 \
    -h 800 \
    --remove-first-ticks 7200 \
...
belt-charts summary "results/bm_*on_patch*.csv" \
    -w 1500 \
    -h 800 \
    --remove-first-ticks 7200 \
...
belt-charts boxplot "results/bm_*mirror*.csv" \
    -w 1200 \
    -h 800 \
    --remove-first-ticks 7200 \
...
belt-charts summary "results/bm_*mirror*.csv" \
    -w 1500 \
    -h 800 \
    --remove-first-ticks 7200 \
