#!/bin/bash
# Run the single-threaded launcher set against the 2056 save files.
# Output goes to results_single_thread/.
set -euo pipefail
...
run_one "factorio_2_0_single_thread" "2_0_77"
run_one "factorio_2_1_single_thread" "2_1_6"
