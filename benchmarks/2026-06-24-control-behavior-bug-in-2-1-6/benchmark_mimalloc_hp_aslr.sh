#!/bin/bash
# Run the stacked mimalloc + huge pages + ASLR off + pinning launcher against
# the 2056 save files. Output goes to results_mimalloc_hp_aslr_off/.
set -euo pipefail
...
runs="50"
pattern="*2056*"
out_dir="results_mimalloc_hp_aslr_off"
...
run_one "factorio_2_0_mimalloc_hp_aslr_off" "2_0_77"
run_one "factorio_2_1_mimalloc_hp_aslr_off" "2_1_6"
